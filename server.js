...
app.post('/api/translate', requireAuth, async (req, res) => {
  ...
  const dictionaries = {
    hi: {
      ...
      "Step-by-step interactive walkthrough of the voting process, timelines, and your rights": "मतदान प्रक्रिया, समयसीमा और अधिकारों का मार्गदर्शन",
      ...
      "Demo Voter IDs (click to copy):": "डेमो वोटर आईडी:",
